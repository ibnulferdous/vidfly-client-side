            ...
            <div className="container mb-7">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                    <div className="col text-center py-4 py-md-0 px-3 px-md-4">
                        ...
                        <h5 className="card-title fw-700">Aerial Photography</h5>
                    ...
                    <div className="col text-center py-4 py-md-0 px-3 px-md-4">
                        ...
                        <h5 className="card-title fw-700 text-capitalize">Smooth Handeling</h5>
                    ...
                    <div className="col text-center py-4 py-md-0 px-3 px-md-4">
                        ...
                        <h5 className="card-title fw-700 text-capitalize">Powerful and Portable</h5>
                    ...
                    <div className="col text-center py-4 py-md-0 px-3 px-md-4">
                        ...
                        <h5 className="card-title fw-700 text-capitalize">Resolution</h5>
